...
class Text(models.Model):
    ...
    transcription=models.CharField(max_length=600,blank=True, null=True)
    
    def __str__(self):
        return self.contenu[:15]
    def save(self, *args, **kwargs):
        new_string =str(self.transcription)
        file_name = '{}.mp3'.format(str(self.transcription).lower().replace(' ', '_'))
